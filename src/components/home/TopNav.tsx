    ...
    <header className="border-b">
      <div className="mx-auto max-w-6xl px-4 py-4 flex items-center gap-4">
        ...
        <div className="ml-auto flex items-center gap-2">
          ...
          <Link
            href="/write"
            className="hidden sm:inline-flex items-center gap-2 rounded-full border px-4 py-2 text-sm hover:bg-slate-50"
          >
          ...
          <button
            type="button"
            className="sm:hidden inline-flex items-center justify-center h-10 w-10 rounded-full border hover:bg-slate-50"
          >
          ...
          <button
            type="button"
            className="inline-flex items-center justify-center h-10 w-10 rounded-full border hover:bg-slate-50"
          >
